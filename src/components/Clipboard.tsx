        ...
        <div class="mx-auto w-full max-w-[400px] ">
          <div class="relative gap-3">
            <input
              type="text"
              ref={inputRef}
              value="spacedev.me@gmail.com"
              readOnly
              class="h-12 w-full rounded-lg border border-stroke border-SpacePalette-300 drop-shadow-custom-blue bg-SpacePalette-200/95 py-3 pl-5 pr-20 outline-none duration-200 focus:border-primary text-SpacePalette-500"
            />
            <button
              onClick={copyToClipboard}
              class="absolute right-2 top-1/2 inline-flex h-8 -translate-y-1/2 items-center justify-center gap-1 rounded-md bg-dark px-2.5 py-1.5 text-sm font-medium text-SpacePalette-500 duration-200 hover:bg-SpacePalette-300/55 hover:text-SpacePalette-500"
            >
              <span class="">
                {copySuccess ? (
