...
export default function PHPIcon(props: JSX.IntrinsicElements['svg']) {
  return (
    <svg 
  {...props}
  xmlns="http://www.w3.org/2000/svg" 
  viewBox="100 -10 200 200"  // Aumentamos el tamaño del viewBox
>
  {/* Elipse del logo */}
  <ellipse 
    cx="200"  // Centramos el elipse en el nuevo viewBox más amplio
    cy="90"   // Lo mantenemos centrado verticalmente
    rx="110"   // El tamaño del radio horizontal que prefieres
    ry="250"   // El tamaño del radio vertical que prefieres
    fill="#787cb4" 
  />

  {/* Letras PHP */}
  <g transform="translate(115, 45) scale(1.8)">  {/* Desplazamos el texto al centro */}
    <path 
      fill="#fff" 
